...
export const routes: Routes = [
  ...
  { path: '', redirectTo: '/home/dashboard/order', pathMatch: 'full' },
  {
    ...
    children:[  // Children paths are appended to the parent path
        ...
        { path:'customers' , component: CustomersComponent   , canActivate: [RoleGuard] ,data:[{selectedHeaderItemIndex:3, selectedSubNavItemIndex:-1,expectedRole: ['ADMIN']}]},
        { path:'employees' , component: EmployeesComponent   , data:[{selectedHeaderItemIndex:4, selectedSubNavItemIndex:-1}]},
        // { path:'managers' , component: ManagersComponent   , data:[{selectedHeaderItemIndex:4, selectedSubNavItemIndex:-1}]  },
        { path: 'signup' , component: UserRegistrationComponent , canActivate: [RoleGuard],data:[{selectedHeaderItemIndex:4, selectedSubNavItemIndex:-1,expectedRole: ['ADMIN']}] },
    ]
  },
